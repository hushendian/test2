    ...
    if (!isShow) {
      ...
      */
      ...
      try {
        ...
        // java.lang.IllegalStateException: View android.widget.TextView{3d2cee7 V.ED..... ......ID
        // 0,0-312,153} has already been added to the window manager.
        ...
        sendEmptyMessageDelayed(
            ...
            mToast.getDuration() == Toast.LENGTH_LONG
                ...
                : ToastHandler.SHORT_DURATION_TIMEOUT);
      } catch (NullPointerException
          | IllegalStateException
          | WindowManager.BadTokenException ignored) {
      }
    }
  }
  ...
  void cancel() {
    ...
    if (isShow) {
      try {
        ...
        // java.lang.IllegalArgumentException: View=android.widget.TextView{3d2cee7 V.ED.....
        // ........ 0,0-312,153} not attached to window manager
